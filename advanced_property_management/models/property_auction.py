...
class PropertyAuction(models.Model):
    ...
    bid_start_price = fields.Float(string='Bid Start Price',
                                      help='The starting bid price for '
                                           'the property', digits='Product Price',)
    final_price = fields.Float(string='Final Price', readonly=True,
                                  help='The final price of the property', digits='Product Price',)
    ...
    def check_start_time_end_time(self):
        ...
        if self.start_time < current_date_time:
            raise ValidationError(_('Please provide a valid date and time'))
        elif self.end_time < current_date_time:
            raise ValidationError(_('Please provide a valid date and time'))
